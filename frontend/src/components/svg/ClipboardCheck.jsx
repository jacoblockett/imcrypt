export default function ClipboardCheck({ className }) {
	return (
		<svg
			className={`icon-clipboard-check${className ? ` ${className}` : ""}`}
			viewBox="0 0 24 24"
			strokeWidth="1.5"
			fill="none"
			...
			<path d="M15.5 4H18C19.1046 4 20 4.89543 20 6V15" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"></path>
			<path
